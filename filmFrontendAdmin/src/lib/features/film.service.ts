...
export const createFilm = async (data:{urlEmbed:string})=>{
    try{
        let axios = await updateAxiosUserInstanceFilm()
        const response = await axios.post(`/createMovie`,data);
        console.log(response.data)
        return response.data;
    }
    catch (error:any){
...
export const deleteFilm = async (data:{id:string})=>{
    try{
        let axios = await updateAxiosUserInstanceFilm()
        const response = await axios.delete(`/deleteMovie/${data.id}`);
        console.log(response.data)
        return response.data;
    }
    catch (error:any){
